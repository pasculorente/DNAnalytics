...
namespace XHMM {
	...
	public:
		...
		static OneToOneStrMap* tableToMap(Table* table, const ullint fromColumn, const ullint toColumn);
	...
	HMM_PP::NamedMatrix<BaseType>* XHMM::xhmmInputManager::MatrixReader<BaseType>::readMatrixFromFile(string file, bool colnames, bool rownames, ullint maxNumRows) {
		...
		HMM_PP::NamedMatrix<BaseType>* mat = new HMM_PP::NamedMatrix<BaseType>();
