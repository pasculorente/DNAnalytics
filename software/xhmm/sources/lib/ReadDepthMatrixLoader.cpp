...
XHMM::ReadDepthMatrixLoader::ReadDepthMatrixLoader(string dataFile, double maxQuantitativeDataVal)
: HMM_PP::DataLoader<HMM_PP::UnivariateQuantitativeData>(dataFile, true, true), // read the targets header line, and the sample IDs
