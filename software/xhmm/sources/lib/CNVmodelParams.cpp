...
HMM_PP::DoubleVec XHMM::CNVmodelParams::getVariableParams() const {
	HMM_PP::DoubleVec v;
...
void XHMM::CNVmodelParams::setVariableParams(const HMM_PP::DoubleVec& v) {
...
double XHMM::CNVmodelParams::transitionFunc(const uint i, const uint j, const uint t1, const uint t2) const {
...
double XHMM::CNVmodelParams::transitionProb(const uint i, const uint j, const uint distInBases) const {
