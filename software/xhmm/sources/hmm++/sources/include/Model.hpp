...
namespace HMM_PP {
	...
	public:
		...
		double transitionFunc(const uint i, const uint j, const uint t1, const uint t2) const;
		...
		// emission function
		double emissionFunc(const Data* seq, const uint hidden_state, const uint t) const;
		vector<double>* emissionFunc(const HMM_PP::Data* seq, const uint t) const;
